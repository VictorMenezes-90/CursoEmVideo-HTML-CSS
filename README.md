...
* Configuração do Ambiente: Instalação e uso do Visual Studio Code (VS Code), extensões essenciais e conceitos de versionamento.
* Estrutura Básica do HTML: Entendimento de tags, atributos, a anatomia de um documento HTML (head, body) e semântica básica.
...
------------------------------
## Sobre o Módulo 2:
O segundo módulo dá vida e beleza às páginas estruturadas no módulo anterior. O foco aqui é transformar códigos simples em layouts visualmente atraentes e profissionais.

* Psicologia e Teoria das Cores: Como criar paletas de cores harmônicas e dominar as representações em CSS (Hexadecimal, RGB, HSL e opacidade com canal Alfa).
* Tipografia para Web: Uso correto de fontes, importação de fontes externas (Google Fonts), alinhamento de textos e propriedades de espaçamento.
